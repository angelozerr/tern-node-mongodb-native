(function(mod) {
  ...
  var defs = {
    ...
    "!define": {
      ...
      db: {
        Db: {
          ...
          prototype: {
            ...
            collectionsInfo: {
              "!type": "fn(collectionName?: string, callback: fn(err: +Error, result: ?))",
              "!url": "http://mongodb.github.io/node-mongodb-native/api-generated/db.html#collectionsinfo",
              "!doc": "Returns a cursor to all the collection information."
            },
            collectionNames: {
              "!type": "fn(collectionName?: string, options?: ?, callback: fn(err: +Error, result: ?))",
              "!url": "http://mongodb.github.io/node-mongodb-native/api-generated/db.html#collectionNames",
              "!doc": "Get the list of all collection names for the specified db"
            },
            collection: {
              "!type": "fn(collectionName: string, options?: +collection.CollectionOptions, callback: fn(err: +Error, collection: +collection.Collection))",
              "!url": "http://mongodb.github.io/node-mongodb-native/api-generated/db.html#collection",
              "!doc": "Fetch a specific collection (containing the actual collection information). If the application does not use strict mode you can can use it without a callback in the following way. var collection = db.collection(‘mycollection’);"
            },
            collections: {
              "!type": "fn(callback: fn(err: +Error, collection: +collection.Collection))",
      ...
      collection: {
        Collection: {
          "!type": "fn(db: +db.Db, collectionName: string, pkFactory?: ?, options: +collection.CollectionOptions)",
          "!url": "http://mongodb.github.io/node-mongodb-native/api-generated/collection.html",
          "!doc": "Create a new Collection instance (INTERNAL TYPE, do not instantiate directly)",
          prototype: {
